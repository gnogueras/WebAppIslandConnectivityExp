...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <form:form class="form-inline" role="form" action="selectNodes" method="POST" modelAttribute="selectedNodes">
                    <div class="form-group">
                        ...
                        <form:select class="form-control" path="fromNode" id="fromNode" items="${nodesListArray}">
                            <!--<optgroup label="Island1">
                                <option>Node1.1</option>
                                <option>Node1.2</option>
                            </optgroup>-->
            ...
            <div class="container" id="detailedResults" style="visibility: hidden">
